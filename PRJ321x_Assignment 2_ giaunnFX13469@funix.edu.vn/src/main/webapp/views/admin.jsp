        ...
        <div class="row">
            <div class="col-2 left">
                <div class="title text-center">
                    <p class="team-title"><span>Welcome ${sessionScope.user}</span></p>
                </div>
                ...
                <div class="logout m-3">
                    <a href="/asm2/LogoutServlet" style="color: #fff; text-decoration: none;"><button type="button" class="btn btn-primary btn-sm btn-left"><i class="fa fa-circle"></i>  Log out</button></a>
